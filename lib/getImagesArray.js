...
var rankImages = function(pixiv){
  ...
  Axios.request({
    ...
    method: "get",
    headers: Object.assign({Cookie: pixiv.cookie}, config.pixiv.headers)
...
3. 获取的是r18列表但是你的pixiv设置中未开启r18`)
    ...
    var items = resData.contents;
    basePath = resData.date
    ...
    for(var i=0;i<items.length;i++){
      ...
      tempimg.illustSrc = "https://www.pixiv.net/member_illust.php?mode=medium&illust_id=" + item.illust_id;
